...
import { PeopleAltOutlined, EventAvailableTwoTone, CurrencyExchangeTwoTone, BookOnlineTwoTone, BookTwoTone, SchoolTwoTone, PersonSearch, Image, DataObject, Dataset, AddModeratorTwoTone, AdminPanelSettingsSharp, Analytics, ReceiptLong, GroupAdd, Hub, Insights } from '@mui/icons-material'; // Import Material-UI icons
...
function LandingPage() {
    ...
    const cardData = [
        ...
        { title: "Workshop Bookings", subtitle: "Monitor workshop bookings with date filters.", link: "/workshopBookings", icon: <ReceiptLong /> },
        { title: "Target users", subtitle: "Recommendations by workshop ID (city + dance overlap).", link: "/targetUsers", icon: <GroupAdd /> },
        { title: "Workshop Master", subtitle: "Workflow hub for Add/Update -> CRM -> Bookings.", link: "/workshopMaster", icon: <Hub /> },
        { title: "Creator Analytics", subtitle: "Fill rate, revenue & monthly earnings per owner and instructor.", link: "/creatorAnalytics", icon: <Insights /> },
